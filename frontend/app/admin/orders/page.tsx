              ...
              >
                <div className="flex items-start justify-between mb-3 gap-3">
                  <div className="space-y-1">
                    <p className="font-bold text-black text-base">{order.ordernr}</p>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100 text-sm text-gray-600">
                  <span className="truncate max-w-[70%]">{order.customer_name || order.customer_email || '–'}</span>
              ...
              <table className="w-full" role="table">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th scope="col" className="text-left px-6 py-4 text-sm font-bold text-gray-700">Datum / Sync</th>
                    ...
                    <tr key={order.web_order_id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          {order.synced_to_erp && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold">ERP</span>
                          )}
                        </div>
                        <p className="text-xs text-gray-500 mt-1">{order.customer_name || order.customer_email || '–'}</p>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 whitespace-nowrap">
                        <div className="flex flex-col gap-1">
                          ...
                          {order.synced_to_erp ? (
                            <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[11px] font-semibold w-fit">
                              Sync: ERP
                            </span>
                          ) : (
                            <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-gray-100 text-gray-700 text-[11px] font-semibold w-fit">
